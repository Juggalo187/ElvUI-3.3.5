				...
				general = {
					...
					args = {
						...
						questIcons = {
							...
							set = function(info, value)
								E.db.nameplates.questIcons[info[#info]] = value
								NP:ConfigureAll()
							...
							args = {
								 status = {
									...
									name = function()
										if C_NamePlate and C_NamePlate.GetNamePlateForUnit then
											return "|cFF00FF00 API Available|r"
										else
											return "|cFFFF0000 API NOT AVAILABLE|r\nRequires AwesomeWotLK patch for C_NamePlate API."
										end
									end,
									fontSize = "medium"
								},
								...
								killIcon = {
									...
									type = "select",
									name = "Kill Icon",
									desc = "Icon to display for kill quests.",
									values = {
										["SKULL"] = "Skull",
										["SWORD"] = "Sword",
										["CROSS"] = "Cross",
								...
								collectIcon = {
									...
									type = "select",
									name = "Collect Icon",
									desc = "Icon to display for collect quests.",
									values = {
										["BAG"] = "Bag",
										["GEM"] = "Gem",
										["COIN"] = "Coin",
