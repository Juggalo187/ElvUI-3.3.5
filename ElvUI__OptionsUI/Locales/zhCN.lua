...
L["Enables the ElvUI_ Raid Control panel."] = "启用ElvUI团队控制面板"
...
L["List of words to color in chat if found in a message. If you wish to add multiple words you must seperate the word with a comma. To search for your current name you can use %MYNAME%.\n\nExample:\n%MYNAME%, ElvUI_, RBGs, Tank"] = "如果在聊天信息中发现如下文字会自动上色该文字. 如果你需要添加多个词必须用逗号分开. 搜索你的名字可使用 %MYNAME%.\n\n例如:\n%MYNAME%, ElvUI_, RBGs, Tank"
...
L["The unit prefixes you want to use when values are shortened in ElvUI_. This is mostly used on UnitFrames."] = "在ElvUI中数值单位的缩写. 该选项主要应用在单位框体"
...
L["This selects the Chat Frame to use as the output of ElvUI_ messages."] = "选择ElvUI信息的聊天输出"
...
举例：Interface\AddOns\ElvUI_\Media\Textures\Copy
