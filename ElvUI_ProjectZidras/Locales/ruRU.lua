...
L["FAQ_DESC"] = "В этом разделе содержатся некоторые вопросы об ElvUI_ и Project Zidras."
L["FAQ_Elv_1"] = "|cff30ee30Q: Где я могу получить помощь по ElvUI_?|r\n|cff9482c9A:|r Лучшим способом будет сервер ElvUI_ - Backport в Discord - https://discord.gg/G6mUMD9TY\nЧтобы сообщить об ошибке вы можете использовать баг-трекер, расположенный по адресу: https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_/issues.\nПредпочтительный язык - английский, однако, если вы русский, то настоятельно рекомендуется написать его так же и по-русски, чтобы ваше сообщение было передано русским разработчикам."
...
L["HD-Nameplates_DESC"] = "Отображать полосу заклинаний (кастбар) ElvUI_ в индикаторах здоровья всех юнитов, а не только цели."
...
L["Modules"] = "Модули"
L["Normal"] = "Нормальный"
L["Options for customizing unit frames. Please don't change these setting when ElvUI_'s testing frames for bosses and arena teams are shown. That will make them invisible until retoggling."] = "Опции для дополнительной настройки рамок юнитов. Пожалуйста, не изменяйте эти настройки в то же время, когда включен тестовый режим рамок боссов и арены в ElvUI_. Это сделает их невидимыми до повторного включения."
