...
local M = [[Interface\AddOns\ElvUI_\Media\]]
...
E.Media = {
	...
	Textures = {
		...
		White8x8 = [[Interface\BUTTONS\WHITE8X8]], -- not ElvUI_
...
LSM:Register("border", "ElvUI_ GlowBorder", E.Media.Textures.GlowTex)
...
LSM:Register("sound", "ElvUI_ Aska", E.Media.Sounds.SndIncMsg)
...
LSM:Register("statusbar", "ElvUI_ Gloss", E.Media.Textures.NormTex)
LSM:Register("statusbar", "ElvUI_ Norm", E.Media.Textures.NormTex2)
LSM:Register("statusbar", "Minimalist", E.Media.Textures.Minimalist)
LSM:Register("statusbar", "ElvUI_ Blank", E.Media.Textures.White8x8)
LSM:Register("background", "ElvUI_ Blank", E.Media.Textures.White8x8)