...
L["Are you sure you want to apply this font to all ElvUI_ elements?"] = true
...
L["Detected that your ElvUI_ OptionsUI addon is out of date. This may be a result of your Tukui Client being out of date. Please visit our download page and update your Tukui Client, then reinstall ElvUI_. Not having your ElvUI_ OptionsUI addon up to date will result in missing options."] = true
L["Disable Warning"] = "Desativar Aviso"
L["Disable"] = "Desativar"
L["Disband Group"] = "Dissolver Grupo"
L["Discard"] = "Descartar"
L["Discord"] = true
L["Do you enjoy the new ElvUI_?"] = true
...
L["Earned:"] = "Ganho:"
L["ElvUI_ Installation"] = "Instalação do ElvUI_"
L["ElvUI_ Plugin Installation"] = true
L["ElvUI_ has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "A ElvUI_ contém o modo de duas especializações, que permite que carregue perfis diferentes baseado na sua especialização atual rapidamente. Você pode ativar esta opção na guia Perfis."
L["ElvUI_ is five or more revisions out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_"] = true
L["ElvUI_ is out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_"] = true
L["ElvUI_ needs to perform database optimizations please be patient."] = true
...
L["For technical support visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = "Para suporte técnico visite-nos no site https://github.com/Juggalo187/ElvUI-3.3.5."
L["For technical support visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = true
L["Frame"] = "Quadro"
...
L["If you are experiencing issues with ElvUI_ try disabling all your addons except ElvUI_, remember ElvUI_ is a full UI replacement addon, you cannot run two addons that do the same thing."] = "Se estiver a ter problemas com a ElvUI_ tente desativar todos os addons exceto a ElvUI_, lembre-se que a ElvUI_ é um addon de substituição de interface completo, e não se consegue executar dois addons que fazem a mesma coisa."
...
L["Oh lord, you have got ElvUI_ and Tukui both enabled at the same time. Select an addon to disable."] = "Oh senhor, você está com os addons ElvUI_ e Tuki ativos ao mesmo tempo. Selecione um para desativar."
...
L["This install process will help you learn some of the features in ElvUI_ has to offer and also prepare your user interface for usage."] = "Este processo de instalação vai mostrar-lhe algumas das opções que a ElvUI_ tem para oferecer e também vai preparar a sua interface para ser usada."
...
L["Welcome to ElvUI_ version %s!"] = "Bem-vindo à versão %s da ElvUI_!"
L["Wintergrasp"] = true
L["XP:"] = "XP:"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = "O processo de instalação está agora terminado. Se precisar de suporte técnico por favor visite-nos no site https://github.com/Juggalo187/ElvUI-3.3.5."
...
L["You can always change fonts and colors of any element of ElvUI_ from the in-game configuration."] = "As cores e fontes da ElvUI_ podem ser mudadas em qualquer momento no modo de configuração demtro do jogo."
