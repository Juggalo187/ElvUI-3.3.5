...
Plugin Table Format: (for reference only).
	{
		...
		callback	- callback to call when ElvUI__OptionsUI is loaded
...
LibElvUIPlugin API:
	...
	-- Posthook ElvUI_ Initialize function:
		table		- addon table
...
local MSG_OUTDATED = "Your version of %s %s is out of date (latest is version %s). You can download the latest version from https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_/"
...
if locale == "deDE" then
	MSG_OUTDATED = "Deine Version von %s %s ist veraltet (akutelle Version ist %s). Du kannst die aktuelle Version von https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_/ herunterrladen."
	HDR_CONFIG = "Plugins"
...
elseif locale == "ruRU" then
	MSG_OUTDATED = "Ваша версия %s %s устарела (последняя версия %s). Вы можете скачать последнюю версию на https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_/"
	HDR_CONFIG = "Плагины"
...
elseif locale == "zhCN" then
	MSG_OUTDATED = "你的 %s %s 版本已经过期 (最新版本是 %s)。你可以从 https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_/ 下载最新版本"
	HDR_CONFIG = "插件"
...
elseif locale == "zhTW" then
	MSG_OUTDATED = "你的 %s %s 版本已經過期 (最新版本為 %s)。你可以透過 https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_/ 下載最新的版本"
	HDR_CONFIG = "插件"
...
function lib:RegisterPlugin(name, callback, isLib, libVersion)
	...
	local loaded = IsAddOnLoaded("ElvUI__OptionsUI")
	if not loaded then
...
function lib:OptionsUILoaded(_, addon)
	if addon == "ElvUI__OptionsUI" then
