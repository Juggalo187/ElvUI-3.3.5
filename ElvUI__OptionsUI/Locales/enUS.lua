...
L["BAGS_DESC"] = "Adjust bag settings for ElvUI_."
L["CHAT_DESC"] = "Adjust chat settings for ElvUI_."
...
L["ELVUI_DESC"] = "ElvUI_ is a complete User Interface replacement addon for World of Warcraft."
