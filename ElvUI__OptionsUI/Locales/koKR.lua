...
L["Enable/Disable the loot roll frame."] = "ElvUI_ 디자인의 입찰 / 차비 / 마력추출을 선택하는 주사위 굴림창 사용 여부를 결정합니다."
...
L["List of words to color in chat if found in a message. If you wish to add multiple words you must seperate the word with a comma. To search for your current name you can use %MYNAME%.\n\nExample:\n%MYNAME%, ElvUI_, RBGs, Tank"] = "이 곳에 키워드를 적으면 모든 대화내용에서 해당 키워드를 발견 시 색깔을 입혀 강조합니다. 쉼표(,) 로 구분해서 작성하세요.|n|n내 이름을 강조하고 싶으면 |cff2eb7e4%MYNAME%|r 을 사용하면 됩니다."
...
L["Reset Zoom"] = "배율 초기화"
L["Reset all frames to their original positions."] = "ElvUI_ 에서 움직일 수 있는 모든 프레임의 위치를 기본 위치로 초기화합니다."
...
L["The unit prefixes you want to use when values are shortened in ElvUI_. This is mostly used on UnitFrames."] = "ElvUI에서 수치를 짧게 표시하고 싶을때 단위를 사용해 축약합니다. 주로 유닛프레임에서 사용됩니다."
...
|cff2eb7e4< 예시 >|r
|cffceff00Interface/AddOns/ElvUI_/Media/Textures/|cff2eb7e4TestImage|r
