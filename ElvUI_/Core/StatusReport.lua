...
local function AreOtherAddOnsEnabled()
	...
	for i = 1, GetNumAddOns() do
		...
		if (name ~= "ElvUI_" and name ~= "ElvUI__OptionsUI") and (loadable or (not loadable and reason == "DEMAND_LOADED")) then --Loaded or load on demand
			return "Yes"
		end
	end
...
function E:CreateStatusFrame()
	...
	--Content lines
	StatusFrame.Section1.Content.Line1.Text:SetFormattedText("Version of ElvUI_: |cff4beb2c%s|r", E.version)
