...
E.PopupDialogs.ELVUI_UPDATED_WHILE_RUNNING = {
	text = L["ElvUI_ was updated while the game is still running. Please relaunch the game, as this is required for the files to be properly updated."],
...
E.PopupDialogs.ELVUI_UPDATE_AVAILABLE = {
	text = L["ElvUI_ is five or more revisions out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_"],
	hasEditBox = 1,
	OnShow = function(self)
		self.editBox:SetAutoFocus(false)
		self.editBox.width = self.editBox:GetWidth()
		self.editBox:Width(220)
		self.editBox:SetText("https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_")
	...
	EditBoxOnTextChanged = function(self)
		if self:GetText() ~= "https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_" then
			self:SetText("https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_")
		end
		self:HighlightText()
		self:ClearFocus()
		ChatEdit_FocusActiveWindow()
...
E.PopupDialogs.CLIENT_UPDATE_REQUEST = {
	text = L["Detected that your ElvUI_ OptionsUI addon is out of date. This may be a result of your Tukui Client being out of date. Please visit our download page and update your Tukui Client, then reinstall ElvUI_. Not having your ElvUI_ OptionsUI addon up to date will result in missing options."],
	button1 = OKAY,
	OnAccept = E.noop,
	showAlert = 1
}
...
E.PopupDialogs.TUKUI_ELVUI_INCOMPATIBLE = {
	text = L["Oh lord, you have got ElvUI_ and Tukui both enabled at the same time. Select an addon to disable."],
	OnAccept = function() DisableAddOn("ElvUI_") ReloadUI() end,
...
E.PopupDialogs.RESET_UF_UNIT = {
	...
	OnAccept = function(self)
		if self.data and self.data.unit then
			...
			if IsAddOnLoaded("ElvUI__OptionsUI") then
				local ACD = E.Libs.AceConfigDialog
				if ACD and ACD.OpenFrames and ACD.OpenFrames.ElvUI_ then
					ACD:SelectGroup("ElvUI_", "unitframe", self.data.unit)
				end
			end
		else
...
E.PopupDialogs.HARLEM_SHAKE = {
	text = L["ElvUI_ needs to perform database optimizations please be patient."],
	button1 = OKAY,
	OnAccept = function()
...
E.PopupDialogs.HELLO_KITTY_END = {
	text = L["Do you enjoy the new ElvUI_?"],
...
E.PopupDialogs.APPLY_FONT_WARNING = {
	text = L["Are you sure you want to apply this font to all ElvUI_ elements?"],
	OnAccept = function()
...
E.PopupDialogs.ELVUI_CONFIG_FOUND = {
	text = L["You still have ElvUI_Config installed. ElvUI_Config has been renamed to ElvUI__OptionsUI, please remove it."],
	button1 = ACCEPT,
	whileDead = 1,
	hideOnEscape = false
}
