...
function S:Ace3_RegisterAsWidget(widget)
	...
	elseif TYPE == "Slider" or TYPE == "Slider-ElvUI_" then
	...
	elseif (TYPE == "ColorPicker" or TYPE == "ColorPicker-ElvUI_") then
		local frame = widget.frame
...
function S:HookAce3(lib, minor) -- lib: AceGUI
	...
	if not S.Ace3_L then
		S.Ace3_L = E.Libs.ACL:GetLocale("ElvUI_", E.global.general.locale or "enUS")
	end
