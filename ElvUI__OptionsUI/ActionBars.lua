...
E.Options.args.actionbar = {
	...
	args = {
		...
		generalShortcut = {
			...
			type = "execute",
			name = L["General"],
			func = function() ACD:SelectGroup("ElvUI_", "actionbar", "general") end,
			disabled = function() return not E.ActionBars.Initialized end
		},
		cooldownTextShortcut = {
			...
			type = "execute",
			name = L["Cooldowns"],
			func = function() ACD:SelectGroup("ElvUI_", "cooldown", "actionbar") end
		},
		petBarShortcut = {
			order = 7,
			type = "execute",
			name = L["Pet Bar"],
			func = function() ACD:SelectGroup("ElvUI_", "actionbar", "barPet") end,
			disabled = function() return not E.ActionBars.Initialized end
		},
		stanceBarShortcut = {
			order = 8,
			type = "execute",
			name = L["Stance Bar"],
			func = function() ACD:SelectGroup("ElvUI_", "actionbar", "stanceBar") end,
			disabled = function() return not E.ActionBars.Initialized end
		},
		spacer2 = {
			order = 9,
		...
		totemBarShortcut = {
			...
			type = "execute",
			name = L["TUTORIAL_TITLE47"],
			func = function() ACD:SelectGroup("ElvUI_", "actionbar", "barTotem") end,
			disabled = function() return not E.ActionBars.Initialized end,
		...
		microbarShortcut = {
			...
			type = "execute",
			name = L["Micro Bar"],
			func = function() ACD:SelectGroup("ElvUI_", "actionbar", "microbar") end,
			disabled = function() return not E.ActionBars.Initialized end
		},
		bar1Shortcut = {
			...
			type = "execute",
			name = L["Bar "]..1,
			func = function() ACD:SelectGroup("ElvUI_", "actionbar", "bar1") end,
			disabled = function() return not E.ActionBars.Initialized end
		},
		bar2Shortcut = {
			...
			type = "execute",
			name = L["Bar "]..2,
			func = function() ACD:SelectGroup("ElvUI_", "actionbar", "bar2") end,
			disabled = function() return not E.ActionBars.Initialized end
		},
		spacer3 = {
			order = 15,
		...
		bar3Shortcut = {
			...
			type = "execute",
			name = L["Bar "]..3,
			func = function() ACD:SelectGroup("ElvUI_", "actionbar", "bar3") end,
			disabled = function() return not E.ActionBars.Initialized end
		},
		bar4Shortcut = {
			...
			type = "execute",
			name = L["Bar "]..4,
			func = function() ACD:SelectGroup("ElvUI_", "actionbar", "bar4") end,
			disabled = function() return not E.ActionBars.Initialized end
		},
		bar5Shortcut = {
			...
			type = "execute",
			name = L["Bar "]..5,
			func = function() ACD:SelectGroup("ElvUI_", "actionbar", "bar5") end,
			disabled = function() return not E.ActionBars.Initialized end
		},
		bar6Shortcut = {
			...
			type = "execute",
			name = L["Bar "]..6,
			func = function() ACD:SelectGroup("ElvUI_", "actionbar", "bar6") end,
			disabled = function() return not E.ActionBars.Initialized end
		}
	}
}
