					...
					filtersGroup = {
						...
						args = {
							...
							jumpToFilter = {
								...
								func = function()
									ACD:SelectGroup("ElvUI_", "filters")
								end
							},
							spacer1 = {
								order = 4,
...
E.Options.args.nameplate = {
	...
	args = {
		...
		generalShortcut = {
			...
			type = "execute",
			name = L["General"],
			func = function() ACD:SelectGroup("ElvUI_", "nameplate", "generalGroup", "general") end,
			disabled = function() return not E.NamePlates.Initialized end
		},
		fontsShortcut = {
			order = 6,
			type = "execute",
			name = L["Fonts"],
			func = function() ACD:SelectGroup("ElvUI_", "nameplate", "generalGroup", "fontGroup") end,
			disabled = function() return not E.NamePlates.Initialized end
		},
		cooldownShortcut = {
			order = 7,
			type = "execute",
			name = L["Cooldowns"],
			func = function() ACD:SelectGroup("ElvUI_", "cooldown", "nameplates") end,
			disabled = function() return not E.NamePlates.Initialized end
		},
		threatShortcut = {
			order = 8,
			type = "execute",
			name = L["Threat"],
			func = function() ACD:SelectGroup("ElvUI_", "nameplate", "generalGroup", "threatGroup") end,
			disabled = function() return not E.NamePlates.Initialized end
		},
		spacer2 = {
			order = 9,
		...
		castBarShortcut = {
			...
			type = "execute",
			name = L["Cast Bar"],
			func = function() ACD:SelectGroup("ElvUI_", "nameplate", "generalGroup", "castGroup") end,
			disabled = function() return not E.NamePlates.Initialized end
		},
		reactionShortcut = {
			order = 12,
			...
			func = function() ACD:SelectGroup("ElvUI_", "nameplate", "generalGroup", "reactions") end,
			disabled = function() return not E.NamePlates.Initialized end
		},
		cutawayHealthShortcut = {
			...
			type = "execute",
			name = L["Cutaway Bars"],
			func = function() ACD:SelectGroup("ElvUI_", "nameplate", "generalGroup", "cutawayHealth") end,
			disabled = function() return not E.NamePlates.Initialized end
		},
		spacer3 = {
			order = 14,
		...
		friendlyPlayerShortcut = {
			...
			type = "execute",
			name = L["FRIENDLY_PLAYER"],
			func = function() ACD:SelectGroup("ElvUI_", "nameplate", "friendlyPlayerGroup") end,
			disabled = function() return not E.NamePlates.Initialized end
		},
		friendlyNPCShortcut = {
			order = 16,
			type = "execute",
			name = L["FRIENDLY_NPC"],
			func = function() ACD:SelectGroup("ElvUI_", "nameplate", "friendlyNPCGroup") end,
			disabled = function() return not E.NamePlates.Initialized end
		},
		enemyPlayerShortcut = {
			order = 17,
			type = "execute",
			name = L["ENEMY_PLAYER"],
			func = function() ACD:SelectGroup("ElvUI_", "nameplate", "enemyPlayerGroup") end,
			disabled = function() return not E.NamePlates.Initialized end
		},
		enemyNPCShortcut = {
			order = 18,
			type = "execute",
			name = L["ENEMY_NPC"],
			func = function() ACD:SelectGroup("ElvUI_", "nameplate", "enemyNPCGroup") end,
			disabled = function() return not E.NamePlates.Initialized end
		},
		spacer4 = {
			order = 19,
		...
		filtersShortcut = {
			...
			type = "execute",
			name = L["Style Filter"],
			func = function() ACD:SelectGroup("ElvUI_", "nameplate", "filters") end,
			disabled = function() return not E.NamePlates.Initialized end
		},
		generalGroup = {
			order = 21,
