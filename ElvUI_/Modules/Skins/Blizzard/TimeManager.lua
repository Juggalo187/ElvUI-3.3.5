...
S:AddCallbackForAddon("Blizzard_TimeManager", "Skin_Blizzard_TimeManager", function()
	...
	StopwatchResetButton:SetNormalTexture("Interface\\AddOns\\ElvUI_\\media\\textures\\reset")
	...
	StopwatchPlayPauseButton:SetNormalTexture("Interface\\AddOns\\ElvUI_\\media\\textures\\play")
	...
	local function SetPauseTexture()
		StopwatchPlayPauseButton:SetNormalTexture("Interface\\AddOns\\ElvUI_\\media\\textures\\pause")
	end
