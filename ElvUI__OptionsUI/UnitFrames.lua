local E, _, V, P, G = unpack(ElvUI_); --Import: Engine, Locales, PrivateDB, ProfileDB, GlobalDB
...
local function GetOptionsTable_AuraBars(updateFunc, groupName)
	local config = {
		...
		args = {
			...
			configureButton1 = {
				...
				func = function() ACD:SelectGroup("ElvUI_", "unitframe", "generalOptionsGroup", "allColorsGroup", "auraBars") end,
			},
			configureButton2 = {
				order = 4,
				type = "execute",
	...
	config.args.filters.args.jumpToFilter = {
		...
		func = function() ACD:SelectGroup("ElvUI_", "filters") end
	}
			...
			duration = {
				...
				args = {
					cooldownShortcut = {
						...
						type = "execute",
						name = L["Cooldowns"],
						func = function() ACD:SelectGroup("ElvUI_", "cooldown", "unitframe") end,
					},
					durationPosition = {
						order = 2,
						type = "select",
	...
	local config = {
		...
		args = {
			...
			configureButton = {
				...
				name = L["Coloring"],
				desc = L["This opens the UnitFrames Color settings. These settings affect all unitframes."],
				func = function() ACD:SelectGroup("ElvUI_", "unitframe", "generalOptionsGroup", "allColorsGroup", "healthGroup") end
			},
			text_format = {
				order = 10,
				type = "input",
	...
	local config = {
		...
		args = {
			...
			configureButton = {
				...
				name = L["Coloring"],
				desc = L["This opens the UnitFrames Color settings. These settings affect all unitframes."],
				func = function() ACD:SelectGroup("ElvUI_", "unitframe", "general", "allColorsGroup", "powerGroup") end,
			},
			position = {
				order = 7,
				type = "select",
	...
	local config = {
		...
		args = {
			...
			configureButton = {
				...
				name = L["Coloring"],
				desc = L["This opens the UnitFrames Color settings. These settings affect all unitframes."],
				func = function() ACD:SelectGroup("ElvUI_", "unitframe", "generalOptionsGroup", "allColorsGroup", "castBars") end
			},
			enable = {
				order = 5,
				type = "toggle",
	...
	local config = {
		...
		args = {
			...
			colors = {
				...
				type = "execute",
				name = L["COLORS"],
				func = function() ACD:SelectGroup("ElvUI_", "unitframe", "generalOptionsGroup", "allColorsGroup", "healPrediction") end,
...
E.Options.args.unitframe = {
	...
	args = {
		...
		generalShortcut = {
			...
			type = "execute",
			name = L["General"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "generalOptionsGroup", "generalGroup") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		frameGlowShortcut = {
			order = 6,
			type = "execute",
			name = L["Frame Glow"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "generalOptionsGroup", "frameGlowGroup") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		cooldownShortcut = {
			order = 7,
		...
		colorsShortcut = {
			...
			type = "execute",
			name = L["COLORS"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "generalOptionsGroup", "allColorsGroup") end,
			disabled = function() return not E.UnitFrames.Initialized end,
		},
		spacer2 = {
			order = 9,
		...
		blizzardShortcut = {
			...
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "generalOptionsGroup", "disabledBlizzardFrames") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		playerShortcut = {
			order = 11,
			type = "execute",
			name = L["Player"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "player") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		targetShortcut = {
			order = 12,
			type = "execute",
			name = L["TARGET"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "target") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		targettargetShortcut = {
			...
			type = "execute",
			name = L["TargetTarget"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "targettarget") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		spacer3 = {
			order = 14,
		...
		targettargettargetShortcut = {
			...
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "targettargettarget") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		focusShortcut = {
			order = 16,
			type = "execute",
			name = L["Focus"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "focus") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		focustargetShortcut = {
			order = 17,
			type = "execute",
			name = L["FocusTarget"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "focustarget") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		petShortcut = {
			order = 18,
			type = "execute",
			name = L["PET"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "pet") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		spacer4 = {
			order = 19,
		...
		pettargetShortcut = {
			...
			type = "execute",
			name = L["PetTarget"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "pettarget") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		arenaShortcut = {
			order = 21,
			type = "execute",
			name = L["ARENA"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "arena") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		bossShortcut = {
			order = 22,
			type = "execute",
			name = L["BOSS"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "boss") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		partyShortcut = {
			order = 23,
			type = "execute",
			name = L["PARTY"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "party") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		spacer6 = {
			order = 24,
		...
		raidShortcut = {
			...
			type = "execute",
			name = L["RAID"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "raid") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		raid40Shortcut = {
			order = 26,
			type = "execute",
			name = L["Raid-40"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "raid40") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		raidpetShortcut = {
			order = 29,
			type = "execute",
			name = L["Raid Pet"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "raidpet") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		assistShortcut = {
			order = 30,
			type = "execute",
			name = L["Assist"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "assist") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		spacer7 = {
			order = 31,
		...
		tankShortcut = {
			...
			type = "execute",
			name = L["TANK"],
			func = function() ACD:SelectGroup("ElvUI_", "unitframe", "tank") end,
			disabled = function() return not E.UnitFrames.Initialized end
		},
		generalOptionsGroup = {
			order = 33,
