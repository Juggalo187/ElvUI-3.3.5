...
L["Enables the ElvUI_ Raid Control panel."] = "啟用ElvUI團隊控制台"
...
L["List of words to color in chat if found in a message. If you wish to add multiple words you must seperate the word with a comma. To search for your current name you can use %MYNAME%.\n\nExample:\n%MYNAME%, ElvUI_, RBGs, Tank"] = "如果在對話信息中發現如下文字會自動上色該文字. 如果你需要添加多個詞必須用逗號分開. 如要搜尋角色名稱可使用%MYNAME %.\n\n例如:\n%MYNAME%, ElvUI_, RBGs, Tank"
...
L["The unit prefixes you want to use when values are shortened in ElvUI_. This is mostly used on UnitFrames."] = "在ElvUI中數值單位的縮寫. 該選項主要應用在單位框架."
...
L["This selects the Chat Frame to use as the output of ElvUI_ messages."] = "選擇ElvUI訊息輸出的聊天視窗"
...
L["BAGS_DESC"] = "調整 ElvUI_ 背包設定."
L["CHAT_DESC"] = "對話框架設定."
L["COOLDOWN_DESC"] = "調整冷卻設定."
L["DATABAR_DESC"] = "設置各種數據條"
L["DATATEXT_DESC"] = "螢幕資訊文字顯示設定."
L["ELVUI_DESC"] = "ElvUI_ 為一套功能完整, 可用來替換 WoW 原始介面的 UI 套件."
...
範例：Interface\AddOns\ElvUI_\Media\Textures\Copy
