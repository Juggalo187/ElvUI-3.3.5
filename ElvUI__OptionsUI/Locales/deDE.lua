...
L["Enables the ElvUI_ Raid Control panel."] = "Aktiviert das ElvUI_ Raid Control Panel."
...
L["List of words to color in chat if found in a message. If you wish to add multiple words you must seperate the word with a comma. To search for your current name you can use %MYNAME%.\n\nExample:\n%MYNAME%, ElvUI_, RBGs, Tank"] = "Liste der Wörter die farblich im Chat erscheinen, wenn sie in einer Nachricht gefunden werden. Wenn du möchtest, kannst du mehrere Wörter hinzufügen. Diese müssen durch ein Komma getrennt werden. Um deinen momentanen Namen zu suchen, benutze %MYNAME%.\n\nBeispiel:\n%MYNAME%, ElvUI_, RBGs, Tank"
...
L["Replaces the default Blizzard fonts on various panels and frames with the fonts chosen in the Media section of the ElvUI_ Options. NOTE: Any font that inherits from the fonts ElvUI_ usually replaces will be affected as well if you disable this. Enabled by default."] = "Ersetzt die Standard Blizzard Schriftarten in verschiedenen Fenstern und Leisten mit den im Medienbereich des ElvUI_ Options gewählten Schriftenarten. HINWEIS: Jede Schrift die ElvUI_ standardmäßig ersetzt ist ebenfalls betroffen wenn du dieses deaktivierst. Standardmäßig aktiviert."
...
L["The unit prefixes you want to use when values are shortened in ElvUI_. This is mostly used on UnitFrames."] = "Der Einheitenpräfix den du benutzen möchtest wenn die Werte von ElvUI_ verkürzt sind. Wird meist auf den Einheitenfenstern benutzt."
...
L["This selects the Chat Frame to use as the output of ElvUI_ messages."] = "Dieses wählt das Chatfenster aus wo die ElvUI_ Nachrichten erscheinen sollen."
...
L["CHAT_DESC"] = "Anpassen der Chateinstellungen für ElvUI_."
...
L["ELVUI_DESC"] = "ElvUI_ ist ein komplettes Benutzerinterface für World of Warcraft."
...
Zum Beispiel: Interface\AddOns\ElvUI_\Media\Textures\Copy
