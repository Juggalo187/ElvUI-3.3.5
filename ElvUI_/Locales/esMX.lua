...
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI_ and setting a keybind for the raid marker."] = "La opción de marcador de banda está disponible pulsando Escape -> Asignar teclas -> Recorrer hacia abajo hasta ElvUI_ y establecer la tecla para el marcador de banda."
...
L["Are you sure you want to apply this font to all ElvUI_ elements?"] = "¿Estás seguro de que deseas aplicar esta fuente a todos los elementos de ElvUI_?"
...
L["Detected that your ElvUI_ OptionsUI addon is out of date. This may be a result of your Tukui Client being out of date. Please visit our download page and update your Tukui Client, then reinstall ElvUI_. Not having your ElvUI_ OptionsUI addon up to date will result in missing options."] = "Se ha detectado que tu addon de ElvUI_ OptionsUI está desactualizado. Ésto puede darse como resultado de que tu cliente Tukui esté desactualizado. Por favor visita nuestra página de descargas y actualiza tu cliente Tukui y entonces reinstala ElvUI_. No tener tu addon ElvUI_ OptionsUI actualizado podría resultar en opciones faltantes."
L["Disable Warning"] = "Deshabilitar Advertencia"
L["Disable"] = "Desactivar"
L["Disband Group"] = "Disolver Grupo"
L["Discard"] = "Descartar"
L["Discord"] = true
L["Do you enjoy the new ElvUI_?"] = "¿Disfrutas del nuevo ElvUI_?"
...
L["Earned:"] = "Ganada:"
L["ElvUI_ Installation"] = "Instalación de ElvUI_"
L["ElvUI_ Plugin Installation"] = "Instalación del plugin de ElvUI_"
L["ElvUI_ has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "ElvUI_ tiene la posibilidad de cargar diferentes perfiles automáticamente al cambiar de especialización de talentos. Puedes activar esta función en la pestaña de perfiles."
L["ElvUI_ is five or more revisions out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5"] = "ElvUI_ está cinco o mas revisiones desactualizado. Puedes descargar la versión más nueva de https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_"
L["ElvUI_ is out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_"] = "ElvUI_ está desactualizado. Puedes descargar la versión más nueva de https://github.com/Juggalo187/ElvUI-3.3.5"
L["ElvUI_ needs to perform database optimizations please be patient."] = "ElvUI_ necesita realizar optimizaciones de base de datos por favor se paciente."
L["ElvUI_ was updated while the game is still running. Please relaunch the game, as this is required for the files to be properly updated."] = "ElvUI_ se actualizó mientras el juego aún se está ejecutando. Vuelve a iniciar el juego, ya que es necesario para que los archivos se actualicen correctamente."
...
L["For technical support visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = "Para soporte técnico visítanos en https://github.com/Juggalo187/ElvUI-3.3.5."
L["Frame"] = "Marco"
...
L["I Swear"] = "Lo Juro"
L["INCOMPATIBLE_ADDON"] = "The addon %s is not compatible with ElvUI_'s %s module. Please select either the addon or the ElvUI_ module to disable."
...
L["If you are experiencing issues with ElvUI_ try disabling all your addons except ElvUI_, remember ElvUI_ is a full UI replacement addon, you cannot run two addons that do the same thing."] = "Si has experimentado errores con ElvUI_ prueba a desactivar todos tus addons excepto ElvUI_, recuerda que ElvUI_ remplaza por completo la interfaz, no puede haber addons que hagan lo mismo."
...
L["Oh lord, you have got ElvUI_ and Tukui both enabled at the same time. Select an addon to disable."] = "Oh cielos, tienes ElvUI_ y Tukui habilitados al mismo tiempo. Elige un addon a deshabilitar"
...
L["This install process will help you learn some of the features in ElvUI_ has to offer and also prepare your user interface for usage."] = "El proceso de instalación te ayudará a aprender algunas de las características de ElvUI_ y preparará la interfaz para su uso."
...
L["Welcome to ElvUI_ version %s!"] = "Bienvenido(a) a ElvUI_ versión %s!"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = "Ya has terminado con el proceso de instalación. Si necesitas ayuda o soporte técnico por favor visítanos en https://github.com/Juggalo187/ElvUI-3.3.5."
...
L["You can always change fonts and colors of any element of ElvUI_ from the in-game configuration."] = "Siempre puedes cambiar las fuentes y colores de cualquier elemento de ElvUI_ desde la configuración."
