				...
				if not ElvDB.profiles[profileKey] then
					...
					E.PopupDialogs.DISTRIBUTOR_CONFIRM = {
						...
						OnAccept = function(popup)
							...
							E.Libs.AceAddon:GetAddon("ElvUI_").data:SetProfile(popup.editBox:GetText())
							E:UpdateAll(true)
			...
			E.PopupDialogs.DISTRIBUTOR_CONFIRM = {
				...
				OnAccept = function()
					if profileKey == "global" then
						...
						E.Libs.AceAddon:GetAddon("ElvUI_").data:SetProfile(profileKey)
					end
					Downloads[sender] = nil
				end,
				OnCancel = function()
