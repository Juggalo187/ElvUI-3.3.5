...
--Usage as seen in ElvUI__OptionsUI\modulecopy.lua
...
* Plugins can use "pluginSection" argument to determain their own table if they keep settings apart from core ElvUI_ settings.
