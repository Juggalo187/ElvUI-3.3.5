...
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI_ and setting a keybind for the raid marker."] = "Ein Feature für Schlachtzugsmarkierung ist verfügbar, wenn du Escape drückst und Tastaturbelegung wählst, scrolle anschließend bis unter die Kategorie ElvUI_ und wähle eine Tastenbelegung für die Schlachtzugsmarkierung."
...
L["Are you sure you want to apply this font to all ElvUI_ elements?"] = "Bist du sicher, dass du diese Schrifart auf alle ElvUI_ Elemente anwenden möchtest?"
...
L["Detected that your ElvUI_ OptionsUI addon is out of date. This may be a result of your Tukui Client being out of date. Please visit our download page and update your Tukui Client, then reinstall ElvUI_. Not having your ElvUI_ OptionsUI addon up to date will result in missing options."] = "Es wurde erkannt dass dein ElvUI_ Konfigurations-Addon veraltet ist. Dies kann das Ergebnis eines veralteten Tukui Clients sein. Bitte besuche unsere Downloadseite und update deinen Tukui Client, dann installiere ElvUI_ neu. Das nicht auf dem neuesten Stand haben des ElvUI_ Konfigurations-Addons wird in fehlenden Optionen resultieren."
L["Disable Warning"] = "Deaktiviere Warnung"
L["Disable"] = "Deaktivieren"
L["Disband Group"] = "Gruppe auflösen"
L["Discard"] = "Verwerfen"
L["Discord"] = true --No need to translate
L["Do you enjoy the new ElvUI_?"] = "Gefällt dir das neue ElvUI_?"
...
L["Earned:"] = "Verdient:"
L["ElvUI_ Installation"] = "ElvUI_ Installation"
L["ElvUI_ Plugin Installation"] = true --No need to translate
L["ElvUI_ has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "ElvUI_ hat ein Feature für Dualspezialisierungen, welches dich abhängig von deiner momentanen Spezialisierung verschiedene Profile laden lässt. Dieses Feature kannst du im Abschnitt Profil aktivieren."
L["ElvUI_ is five or more revisions out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5"] = "ElvUI_ ist seit fünf oder mehr Revisionen nicht aktuell. Du kannst die neuste Version bei https://github.com/Juggalo187/ElvUI-3.3.5 herunterladen"
L["ElvUI_ is out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5"] = "ElvUI_ ist nicht aktuell. Du kannst die neuste Version bei https://github.com/Juggalo187/ElvUI-3.3.5 herunterladen"
L["ElvUI_ needs to perform database optimizations please be patient."] = "ElvUI_ muss eine Datenbank Optimierung durchführen. Bitte warte eine Moment."
L["ElvUI_ was updated while the game is still running. Please relaunch the game, as this is required for the files to be properly updated."] = "ElvUI_ wurde upgedated während das Spiel noch läuft. Bitte starte das Spiel neu, damit alle Dateien richtig geupdated werden."
...
L["For technical support visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = "Für technische Hilfe besuche uns unter https://github.com/Juggalo187/ElvUI-3.3.5."
L["Frame"] = "Fenster"
...
L["INCOMPATIBLE_ADDON"] = "Das Addon %s ist nicht mit dem ElvUI_ %s Modul kompatibel. Bitte deaktiviere entweder das Addon oder deaktiviere das ElvUI_ Modul."
...
L["If you are experiencing issues with ElvUI_ try disabling all your addons except ElvUI_, remember ElvUI_ is a full UI replacement addon, you cannot run two addons that do the same thing."] = "Wenn du Probleme mit ElvUI_ hast, deaktiviere alle Addons außer ElvUI_. Denke auch daran, dass ElvUI_ die komplette Benutzeroberfläche ersetzt, d.h. du kannst kein Addon verwenden, welches die gleichen Funktionen wie ElvUI_ nutzt."
...
L["KEY_SPACE"] = "SpB"
L["Key"] = "Taste"
L["LOGIN_MSG"] = "Willkommen zu %sElvUI|r Version %s%s|r, Tippe /ec um das Konfigurationsmenü aufzurufen. Für technische Hilfe, besuche das Supportforum unter https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_ oder trete unserem Discord bei: https://discord.gg/G6mUMD9TY"
...
L["Offline"] = "Offline"
L["Oh lord, you have got ElvUI_ and Tukui both enabled at the same time. Select an addon to disable."] = "Oh Gott, du hast ElvUI_ und Tukui zur gleichen Zeit aktiviert. Wähle ein Addon um es zu deaktivieren."
...
L["Select the type of aura system you want to use with ElvUI_'s unitframes. Set to Aura Bar & Icons to use both aura bars and icons, set to icons only to only see icons."] = "Wähle eine Aurensystem aus dass du für die ElvUI_ Einheitenfenster benutzen möchtest. Setze Aurenleiste & Symbole um beides zu nutzen. Setze zu Symbole um nur Symbole zu verwenden."
L["Server: "] = "Server: "
L["Session:"] = "Sitzung:"
...
L["The in-game configuration menu can be accessed by typing the /ec command or by clicking the 'C' button on the minimap. Press the button below if you wish to skip the installation process."] = "Das ElvUI_-Konfigurationsmenü kannst du entweder mit /ec oder durch das Anklicken der 'C' Taste an der Minimap aufrufen. Drücke 'Schritt überspringen' um zum nächsten Schritt zu gelangen."
...
L["This install process will help you learn some of the features in ElvUI_ has to offer and also prepare your user interface for usage."] = "Dieser Installationsprozess wird dir helfen, die Funktionen von ElvUI_ für deine Benutzeroberfläche besser kennenzulernen."
...
L["Welcome to ElvUI_ version %s!"] = "Willkommen bei ElvUI_ Version %s!"
L["Wintergrasp"] = true
L["XP:"] = "EP:"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = "Du hast den Installationsprozess abgeschlossen. Solltest du technische Hilfe benötigen, besuche uns auf https://github.com/Juggalo187/ElvUI-3.3.5."
...
L["You can always change fonts and colors of any element of ElvUI_ from the in-game configuration."] = "Du kannst jederzeit in der Ingame-Konfiguration Schriften und Farben von jedem Element des Interfaces ändern."
...
L["You still have ElvUI_Config installed. ElvUI_Config has been renamed to ElvUI__OptionsUI, please remove it."] = true
