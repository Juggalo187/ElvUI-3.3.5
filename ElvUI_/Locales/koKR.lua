...
L["%s is attempting to share the profile %s with you. Would you like to accept the request?"] = "%s 유저가 ElvUI_ 설정을 전송하려 합니다. 받으시겠습니까?"
...
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI_ and setting a keybind for the raid marker."] = "단축키 설정의 맨 아래에 있는 ElvUI_ 부분에서 |cff2eb7e4[Raid Marker]|r 기능을 사용하면 대상에게 징표를 간단히 찍을 수 있습니다."
...
L["Are you sure you want to apply this font to all ElvUI_ elements?"] = "정말로 이 글씨체를 ElvUI의 모든 구성요소에 적용하시겠습니까?"
...
L["Detected that your ElvUI_ OptionsUI addon is out of date. This may be a result of your Tukui Client being out of date. Please visit our download page and update your Tukui Client, then reinstall ElvUI_. Not having your ElvUI_ OptionsUI addon up to date will result in missing options."] = "ElvUI__OptionsUI 가 오래된 버전입니다. Tukui Client 프로그램을 쓰고 있으면 클라이언트를 업데이트하고 ElvUI를 재설치하세요."
L["Disable Warning"] = "비활성화 경고"
L["Disable"] = "비활성화"
L["Disband Group"] = "그룹 해산"
L["Discard"] = "작업 취소"
L["Discord"] = true
L["Do you enjoy the new ElvUI_?"] = "만우절 기능이었습니다! 이대로 쓰실래요?"
...
L["Earned:"] = "수입:"
L["ElvUI_ Installation"] = "ElvUI_ 설치"
L["ElvUI_ Plugin Installation"] = "ElvUI_ 플러그인 설치"
L["ElvUI_ has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "각 전문화별로 ElvUI_ 설정을 따로 지정할 수 있습니다. 설정의 프로필 항목에 |cff2eb7e4[이중 프로필 사용]|r 기능을 확인하세요."
L["ElvUI_ is five or more revisions out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_"] = "현재 사용하는 ElvUI가 5버전 이상 뒤쳐진 버전입니다. https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_ 에서 새 버전을 다운로드 받으세요"
L["ElvUI_ is out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_"] = "ElvUI가 오래된 버전입니다. https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_ 에서 새 버전을 다운로드 받으세요."
L["ElvUI_ needs to perform database optimizations please be patient."] = "ElvUI의 데이터베이스를 조정할 필요가 있습니다. 잠시 기다려주세요."
...
L["For technical support visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = "궁금한 사항이나 기술지원은 |cff2eb7e4github.com/ElvUI_-WotLK|r에서 해결하세요."
L["Frame"] = "유닛프레임"
...
L["If you accidently remove a chat frame you can always go the in-game configuration menu, press install, go to the chat portion and reset them."] = "ElvUI_ 에서 지원하는 대부분의 기능은 |cff2eb7e4/ec|r 에서 조정이 가능합니다. 하고 싶은 조절 기능이 없다면 직접 lua수정으로 고쳐야 합니다."
L["If you are experiencing issues with ElvUI_ try disabling all your addons except ElvUI_, remember ElvUI_ is a full UI replacement addon, you cannot run two addons that do the same thing."] = "ElvUI에서 지원하는 기능과 겹치는 다른 애드온을 쓰고 싶으면 ElvUI_ 설정에서 해당 기능을 사용 체크해제 해야합니다. (예: Bartender, Dominos)"
...
L["Offline"] = "오프라인"
L["Oh lord, you have got ElvUI_ and Tukui both enabled at the same time. Select an addon to disable."] = "ElvUI_ 와 TukUI 를 동시에 사용하려 하고 있습니다. 하나만 선택해 주세요."
...
L["Preview"] = true
L["Profile download complete from %s, but the profile %s already exists. Change the name or else it will overwrite the existing profile."] = "%s 유저에게서 ElvUI_ 설정 다운로드가 완료되었습니다. 하지만 건네받은 프로필 이름이 이미 존재합니다. 프로필이름을 바꾸지 않으면 기존의 것에 덮어씌웁니다."
L["Profile download complete from %s, would you like to load the profile %s now?"] = "%s 유저에게서 ElvUI_ 설정 다운로드가 완료되었습니다. 건네받은 설정을 지금 불러올까요?"
...
L["Theme Set"] = "테마 적용"
L["Theme Setup"] = "테마 설정"
L["This install process will help you learn some of the features in ElvUI_ has to offer and also prepare your user interface for usage."] = "이 설치과정을 통해 ElvUI를 좀 더 자신에게 맞게 설정하고|n몇가지 기능에 대해 알 수 있습니다."
...
L["Toggle Configuration"] = "ElvUI_ 설정창 열기"
L["Tooltip"] = "툴팁"
...
L["Welcome to ElvUI_ version %s!"] = "ElvUI_ 버전 %s에 오신 것을 환영합니다!"
L["Wintergrasp"] = true
L["XP:"] = "경험치:"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = "설치 과정이 끝났습니다.|n궁금한 점 해결이나 기술지원이 필요하면 https://github.com/Juggalo187/ElvUI-3.3.5 를 방문하세요."
...
L["You can always change fonts and colors of any element of ElvUI_ from the in-game configuration."] = "ElvUI에서 표시하는 폰트나 색상은 설정에서 언제든지 바꿀 수 있습니다."
