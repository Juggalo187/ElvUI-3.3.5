...
local function SetPage(PageNum)
	...
	if PageNum == 1 then
		f.SubTitle:SetFormattedText(L["Welcome to ElvUI_ version %s!"], E.version)
		f.Desc1:SetText(L["This install process will help you learn some of the features in ElvUI_ has to offer and also prepare your user interface for usage."])
	...
	elseif PageNum == 4 then
		...
		f.Desc2:SetText(L["You can always change fonts and colors of any element of ElvUI_ from the in-game configuration."])
	...
	elseif PageNum == 7 then
		...
		f.Desc1:SetText(L["Select the type of aura system you want to use with ElvUI_'s unitframes. Set to Aura Bar & Icons to use both aura bars and icons, set to icons only to only see icons."])
	...
	elseif PageNum == 8 then
		...
		f.Desc1:SetText(L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/Juggalo187/ElvUI-3.3.5."])
		f.Desc2:SetText(L["Please click the button below so you can setup variables and ReloadUI."])
		InstallOption1Button:Show()
		InstallOption1Button:SetScript("OnClick", function() E:StaticPopup_Show("ELVUI_EDITBOX", nil, nil, "https://discord.gg/G6mUMD9TY") end)
		InstallOption1Button:SetText(L["Skuly's Discord"])
		InstallOption2Button:Show()
...
function E:Install()
	if not InstallStepComplete then
		...
		imsg.bg:SetTexture([[Interface\AddOns\ElvUI_\media\textures\LevelUpTex]])
		...
		imsg.lineTop:SetTexture([[Interface\AddOns\ElvUI_\media\textures\LevelUpTex]])
		...
		imsg.lineBottom:SetTexture([[Interface\AddOns\ElvUI_\media\textures\LevelUpTex]])
	...
	if not ElvUIInstallFrame then
		...
		f.Title:SetText(L["ElvUI_ Installation"])
