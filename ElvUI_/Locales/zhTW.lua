...
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI_ and setting a keybind for the raid marker."] = "你可以通過按ESC鍵-> 按鍵設定, 滾動到ElvUI設定下方設定一個快速標記的快捷鍵."
...
L["Are you sure you want to apply this font to all ElvUI_ elements?"] = "你確定要將此字型應用到所有 ElvUI_ 部件嗎?"
...
L["Detected that your ElvUI_ OptionsUI addon is out of date. This may be a result of your Tukui Client being out of date. Please visit our download page and update your Tukui Client, then reinstall ElvUI_. Not having your ElvUI_ OptionsUI addon up to date will result in missing options."] = "偵測到你的 ElvUI_ 設定插件已過期. 這可能是因為你的 Tukui 客戶端已過期. 請拜訪我們的下載頁面並更新 Tukui 客戶端然後再重新安裝 ElvUI_. ElvUI_ 設定插件過期會造成某些選項遺失"
L["Disable Warning"] = "停用警告"
L["Disable"] = "停用"
L["Disband Group"] = "解散隊伍"
L["Discard"] = "取消"
L["Discord"] = true
L["Do you enjoy the new ElvUI_?"] = "你享受新版的ElvUI嗎?"
...
L["Earned:"] = "賺取:"
L["ElvUI_ Installation"] = "安裝 ElvUI_"
L["ElvUI_ Plugin Installation"] = "ElvUI_ 插件安裝"
L["ElvUI_ has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "ElvUI_ 可以根據你所使用的天賦自動套用不同的裝備組. 你可以在設定檔中啟用此功能."
L["ElvUI_ is five or more revisions out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5"] = "ElvUI_ 已過期超過5個版本. 你可以在 https://github.com/Juggalo187/ElvUI-3.3.5 下載到最新的版本."
L["ElvUI_ is out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5"] = "ElvUI_ 已過期. 你可以在 https://github.com/Juggalo187/ElvUI-3.3.5 下載到最新的版本."
L["ElvUI_ needs to perform database optimizations please be patient."] = "ElvUI_ 需要進行資料庫優化, 請稍待."
L["ElvUI_ was updated while the game is still running. Please relaunch the game, as this is required for the files to be properly updated."] = "ElvUI_ 在遊戲運行時被更新了. 請重開遊戲以確保文件的完整更新."
L["Empty Slot"] = "空格"
L["Enable"] = "啟用"
...
L["For technical support visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = "如需技術支援請至 https://github.com/Juggalo187/ElvUI-3.3.5."
L["Frame"] = "框架"
L["Friends List"] = "好友列表"
L["G"] = "公會"
...
L["I Swear"] = "我承諾"
L["INCOMPATIBLE_ADDON"] = "插件 %s 與 ElvUI_ 的 %s 模組不相容。請停用不相容的插件, 或停用相關的模組."
L["Icons Only"] = "圖示"
...
L["If you are experiencing issues with ElvUI_ try disabling all your addons except ElvUI_, remember ElvUI_ is a full UI replacement addon, you cannot run two addons that do the same thing."] = "如果你使用 ElvUI_ 時遇到問題, 請嘗試停用除了ElvUI之外的插件. 請記住ElvUI是一套全套的UI替換插件, 你不能同時使用不同的插件來完成同一件事."
...
L["KEY_SPACE"] = "SpB"
L["Key"] = "鍵"
L["LOGIN_MSG"] = "歡迎使用 %sElvUI|r %s%s 版本|r, 輸入 /ec 可打開遊戲內設置介面. 如果你需要技術協助, 可訪問我們的網址 https://github.com/Juggalo187/ElvUI-3.3.5 或是加入我們的 Discord 伺服器: https://discord.gg/G6mUMD9TY"
L["Layout Set"] = "版面配置設定"
L["Layout"] = "介面佈局"
L["Left Chat"] = "左側對話框"
L["Left Click:"] = "滑鼠左鍵："
...
L["Offline"] = "離線"
L["Oh lord, you have got ElvUI_ and Tukui both enabled at the same time. Select an addon to disable."] = "喔 拜託,你不能同時使用 ElvUI_ 和 Tukui, 請選擇一個停用."
...
L["Select the type of aura system you want to use with ElvUI_'s unitframes. Set to Aura Bar & Icons to use both aura bars and icons, set to icons only to only see icons."] = "選擇你想用在 ElvUI_ 單位框架上的光環系統類型. 選擇光環條及圖標將會同時顯示光環條及光環圖標, 如果選擇圖標就只會顯示光環圖標."
L["Server: "] = "伺服器: "
L["Session:"] = "本次登入:"
L["Setup CVars"] = "設定參數"
L["Setup Chat"] = "設定對話視窗"
...
L["Theme Set"] = "主題設定"
L["Theme Setup"] = "主題安裝"
L["This install process will help you learn some of the features in ElvUI_ has to offer and also prepare your user interface for usage."] = "此安裝程序有助你瞭解ElvUI 部份功能, 並可協助你預先設定UI."
...
L["Welcome to ElvUI_ version %s!"] = "歡迎使用 ElvUI_ %s 版！"
L["Wintergrasp"] = true
L["XP:"] = "經驗:"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = "已完成安裝程序. 小提示: 若想開啟微型選單, 請在小地圖按滑鼠中鍵. 如果沒有中鍵按鈕, 請按住Shift鍵, 並在小地圖按滑鼠右鍵. 如需技術支援請至https://github.com/Juggalo187/ElvUI-3.3.5"
...
L["You can always change fonts and colors of any element of ElvUI_ from the in-game configuration."] = "你可以在遊戲內的設定選項內更改ElvUI的字體、顏色等設定."
