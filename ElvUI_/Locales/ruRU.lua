...
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI_ and setting a keybind for the raid marker."] = "Функция рейдовых меток доступна в Escape -> Назначение клавиш. Прокрутите вниз до раздела ElvUI_ и назначьте клавишу для рейдовых меток."
...
L["Are you sure you want to apply this font to all ElvUI_ elements?"] = "Вы уверены, что хотите применить этот шрифт ко всем элементам ElvUI_?"
...
L["Do you enjoy the new ElvUI_?"] = "Вам нравится ElvUI_?"
...
L["Earned:"] = "Заработано"
L["ElvUI_ Installation"] = "Установка ElvUI_"
L["ElvUI_ Plugin Installation"] = "Установка плагина ElvUI_"
L["ElvUI_ has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "В ElvUI_ присутствует функция двойной специализации, которая позволит Вам использовать разные профили для разных наборов талантов. Вы можете включить эту функцию в разделе профилей."
L["ElvUI_ is five or more revisions out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5"] = "Ваш ElvUI_ устарел более, чем на 5 версий. Обновите его на https://github.com/Juggalo187/ElvUI-3.3.5_"
L["ElvUI_ is out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5"] = "ElvUI_ устарел. Вы можете скачать последнюю версию с https://github.com/Juggalo187/ElvUI-3.3.5"
L["ElvUI_ needs to perform database optimizations please be patient."] = "ElvUI_ нужно провести оптимизацию базы данных. Подождите, пожалуйста."
L["ElvUI_ was updated while the game is still running. Please relaunch the game, as this is required for the files to be properly updated."] = "ElvUI_ обновился, пока игра была запущена. Перезапустите игру, чтобы обновления могли по человечески примениться."
...
L["For technical support visit us at https://github.com/Juggalo187/ElvUI-3.3.5"] = "За технической поддержкой обращайтесь на https://github.com/Juggalo187/ElvUI-3.3.5."
L["Frame"] = "Рамка"
...
L["I Swear"] = "Я клянусь!"
L["INCOMPATIBLE_ADDON"] = "Аддон %s не совместим с модулем %s ElvUI_. Пожалуйста, выберите отключить ли несовместимый аддон или модуль."
...
L["If you are experiencing issues with ElvUI_ try disabling all your addons except ElvUI_, remember ElvUI_ is a full UI replacement addon, you cannot run two addons that do the same thing."] = "Если Вы испытываете проблемы с ElvUI_, попробуйте отключить все аддоны, кроме самого ElvUI_. Помните, ElvUI_ это аддон, полностью заменяющий интерфейс, Вы не можете одновременно использовать два аддона, выполняющих одинаковые функции."
...
L["KEY_SPACE"] = "SpB"
L["Key"] = "Клавиша"
L["LOGIN_MSG"] = "Добро пожаловать в %sElvUI|r версии %s%s|r, наберите /ec для доступа в меню настроек. Если Вам нужна техническая поддержка, посетите наш форум на https://github.com/Juggalo187/ElvUI-3.3.5 или присоединяйтесь к серверу Discord: https://discord.gg/G6mUMD9TY"
...
L["Offline"] = "Не в сети"
L["Oh lord, you have got ElvUI_ and Tukui both enabled at the same time. Select an addon to disable."] = "Японский городовой... у Вас одновременно включены ElvUI_ и Tukui. Выберите аддон для отключения."
...
L["Theme Setup"] = "Тема"
L["This install process will help you learn some of the features in ElvUI_ has to offer and also prepare your user interface for usage."] = "Этот процесс установки поможет Вам узнать о некоторых функциях ElvUI_ и подготовить Ваш интерфейс к использованию."
...
L["Welcome to ElvUI_ version %s!"] = "Добро пожаловать в ElvUI_ версии %s!"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/Juggalo187/ElvUI-3.3.5"] = "Вы завершили процесс установки. Если Вам требуется техническая поддержка, посетите сайт https://github.com/Juggalo187/ElvUI-3.3.5."
...
L["You can always change fonts and colors of any element of ElvUI_ from the in-game configuration."] = "Вы всегда можете изменить шрифты и цвета любого элемента ElvUI_ из меню конфигурации. Классическая и пиксельная темы не отличаются для русского клиента."
