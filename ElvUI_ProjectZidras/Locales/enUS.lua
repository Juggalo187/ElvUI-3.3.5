...
L["FAQ_DESC"] = "This section contains some questions about ElvUI_ and Project Zidras."
L["FAQ_Elv_1"] = "|cff30ee30Q: Where can I get ElvUI_ support?|r\n|cff9482c9A:|r The best way would be the ElvUI_ - Backport discord - https://discord.gg/G6mUMD9TY\nTo report a bug, you can use the issue tracker located at https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_/issues.\nEnglish should be the chosen language, however, if you are Russian, it is highly recommended that you (also) write it in Russian to better convey your message to our russian Developers."
...
L["HD-Nameplates_DESC"] = "Applies ElvUI_ castbars to default Blizzard nameplate castbars for all units and cached GUID nameplates."
L["Heal Absorbs"] = true
