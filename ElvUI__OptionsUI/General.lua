		...
		general = {
			...
			args = {
				...
				messageRedirect = {
					...
					type = "select",
					name = L["Chat Output"],
					desc = L["This selects the Chat Frame to use as the output of ElvUI_ messages."],
				...
				numberPrefixStyle = {
					...
					desc = L["The unit prefixes you want to use when values are shortened in ElvUI_. This is mostly used on UnitFrames."],
					set = function(info, value)
				...
				fontGroup = {
					...
					args = {
						...
						replaceBlizzFonts = {
							...
							desc = L["Replaces the default Blizzard fonts on various panels and frames with the fonts chosen in the Media section of the ElvUI_ Options. NOTE: Any font that inherits from the fonts ElvUI_ usually replaces will be affected as well if you disable this. Enabled by default."],
							get = function(info) return E.private.general[info[#info]] end,
		...
		blizzUIImprovements = {
			...
			args = {
				...
				raidUtility = {
					...
					type = "toggle",
					name = L["RAID_CONTROL"],
					desc = L["Enables the ElvUI_ Raid Control panel."],
					get = function(info) return E.private.general[info[#info]] end,
					set = function(info, value)
						E.private.general[info[#info]] = value
						E:StaticPopup_Show("PRIVATE_RL")
