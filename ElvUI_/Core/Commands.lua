...
function E:LuaError(msg)
	...
	if msg == "on" or msg == "1" then
		...
		for i = 1, GetNumAddOns() do
			...
			if enabled and name ~= "ElvUI_" and name ~= "ElvUI__OptionsUI" then
...
function E:GetCPUImpact()
	...
	if not toggleMode then
		...
		local per, passed =
			((num_frames == 0 and 0) or (GetAddOnCPUUsage("ElvUI_") / num_frames)),
...
function E:LoadCommands()
	...
	self:RegisterChatCommand("ElvUI_", "ToggleOptionsUI")
