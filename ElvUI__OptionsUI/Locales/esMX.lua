...
L["Enables the ElvUI_ Raid Control panel."] = true
...
L["List of words to color in chat if found in a message. If you wish to add multiple words you must seperate the word with a comma. To search for your current name you can use %MYNAME%.\n\nExample:\n%MYNAME%, ElvUI_, RBGs, Tank"] = "Lista de palabras a colorear si son encontradas en un mensaje del chat. Si quieres agregar varias palabras debes separarlas con comas. Para buscar tu nombre actual puedes usar %MYNAME%.\n\nEjemplo:\n%MYNAME%, ElvUI_, Tanque"
...
L["BAGS_DESC"] = "Ajusta las opciones de las bolsas para ElvUI_."
L["CHAT_DESC"] = "Configura los ajustes del chat para ElvUI_."
L["COOLDOWN_DESC"] = "Adjust Cooldown Settings."
L["DATATEXT_DESC"] = "Configura el despliegue en pantalla de los textos de datos."
L["ELVUI_DESC"] = "ElvUI_ es un addon que reemplaza la interfaz completa de World of Warcraft."
...
Ejemplo: Interface\AddOns\ElvUI_\Media\Textures\Copy
