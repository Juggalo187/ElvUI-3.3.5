...
L["Enables the ElvUI_ Raid Control panel."] = "Activer le panneau de raid d'ElvUI_"
...
L["List of words to color in chat if found in a message. If you wish to add multiple words you must seperate the word with a comma. To search for your current name you can use %MYNAME%.\n\nExample:\n%MYNAME%, ElvUI_, RBGs, Tank"] = "Liste des mots à colorer dans la fenêtre de discussion s'ils y sont trouvés. Si vous souhaitez ajouter plusieurs mots, vous devez séparer le mot avec une virgule. Pour rechercher votre nom actuel, vous pouvez utiliser %MYNAME%.\n\nExemple:\n%MYNAME%, ElvUI_, RBG, Tank"
...
L["Replaces the default Blizzard fonts on various panels and frames with the fonts chosen in the Media section of the ElvUI_ Options. NOTE: Any font that inherits from the fonts ElvUI_ usually replaces will be affected as well if you disable this. Enabled by default."] = true
...
L["The unit prefixes you want to use when values are shortened in ElvUI_. This is mostly used on UnitFrames."] = true
...
L["This selects the Chat Frame to use as the output of ElvUI_ messages."] = true
...
L["BAGS_DESC"] = "Ajuster les paramètres des sacs pour ElvUI_."
L["CHAT_DESC"] = "Ajuste les paramètres du chat pour ElvUI_."
L["COOLDOWN_DESC"] = "Adjust Cooldown Settings."
L["DATATEXT_DESC"] = "Configuration de l'affichage des textes d'informations."
L["ELVUI_DESC"] = "ElvUI_ est une interface de remplacement complète pour World of Warcraft."
...
L["TOGGLESKIN_DESC"] = "Active ou désactive l'habillage ElvUI_ des éléments ci-dessous."
...
Exemple: Interface\AddOns\ElvUI_\Media\Textures\Copy
