...
Engine[2] = E.Libs.ACL:GetLocale("ElvUI_", loc)
if type(Engine[2]) ~= "table" then
    Engine[2] = E.Libs.ACL:GetLocale("ElvUI_", "enUS", true)
...
E:AddLib("AceConfig", "AceConfig-3.0-ElvUI_")
E:AddLib("AceConfigDialog", "AceConfigDialog-3.0-ElvUI_")
E:AddLib("AceConfigRegistry", "AceConfigRegistry-3.0-ElvUI_")
...
function E:RefreshGUI()
	...
	E.Libs.AceConfigRegistry:NotifyChange("ElvUI_")
end

E.Libs.AceConfig:RegisterOptionsTable("ElvUI_", E.Options)
E.Libs.AceConfigDialog:SetDefaultSize("ElvUI_", E:GetConfigDefaultSize())
...
local function ExportImport_Open(mode)
	...
	Frame:SetCallback("OnClose", function(widget)
		...
		E.Libs.AceConfigDialog:Open("ElvUI_")
	end)
	...
	--Close ElvUI_ OptionsUI
	E.Libs.AceConfigDialog:Close("ElvUI_")
...
E.Options.args.profiles.plugins.ElvUI_ = {
	spacer = {
		order = 89,
		type = "description",
		name = "\n\n"
