...
L["Enable/Disable the loot frame."] = "Включить/выключить окно добычи ElvUI_."
L["Enable/Disable the loot roll frame."] = "Включить/выключить фрейм распределения добычи ElvUI_."
...
L["Enables the ElvUI_ Raid Control panel."] = "Включает панель управления рейдом ElvUI_."
...
L["List of words to color in chat if found in a message. If you wish to add multiple words you must seperate the word with a comma. To search for your current name you can use %MYNAME%.\n\nExample:\n%MYNAME%, ElvUI_, RBGs, Tank"] = "Список слов для окрашивания, если они обнаружены в чате. Если Вы хотите добавить несколько слов, то разделяйте их запятыми. Для поиска имени Вашего текущего персонажа используйте %MYNAME%.\n\nПример:\n%MYNAME%, ElvUI_, РБГ, Танк"
...
L["The unit prefixes you want to use when values are shortened in ElvUI_. This is mostly used on UnitFrames."] = "Сокращения для значений, показываемых ElvUI_. В большинстве своем используются для рамок юнитов."
...
L["This selects the Chat Frame to use as the output of ElvUI_ messages."] = "В какой чат отправлять сообщения от ElvUI_."
...
L["BAGS_DESC"] = "Настройки сумок ElvUI_"
L["CHAT_DESC"] = "Настройте отображение чата ElvUI_."
...
L["ELVUI_DESC"] = "ElvUI_ это аддон для полной замены пользовательского интерфейса World of Warcraft."
...
Пример: Interface\AddOns\ElvUI_\Media\Textures\Copy
