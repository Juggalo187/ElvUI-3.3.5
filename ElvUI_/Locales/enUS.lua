...
local L = E.Libs.ACL:NewLocale("ElvUI_", "enUS", true, true)
...
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI_ and setting a keybind for the raid marker."] = true
...
L["Earned:"] = true
L["ElvUI_ Installation"] = true
L["ElvUI_ Plugin Installation"] = true
L["ElvUI_ has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = true
L["ElvUI_ is five or more revisions out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5"] = true
L["ElvUI_ is out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5"] = true
...
L["If you are experiencing issues with ElvUI_ try disabling all your addons except ElvUI_, remember ElvUI_ is a full UI replacement addon, you cannot run two addons that do the same thing."] = true
...
L["KEY_SPACE"] = "SpB"
L["Key"] = true
L["LOGIN_MSG"] = "Welcome to %sElvUI|r version %s%s|r, type /ec to access the in-game configuration menu. If you are in need of technical support you can visit us at https://github.com/Juggalo187/ElvUI-3.3.5 or join our Discord: https://discord.gg/G6mUMD9TY"
L["Layout Set"] = true
L["Layout"] = true
L["Left Chat"] = true
L["Left Click:"] = true
...
L["Offline"] = true
L["Oh lord, you have got ElvUI_ and Tukui both enabled at the same time. Select an addon to disable."] = true
...
L["Theme Set"] = true
L["Theme Setup"] = true
L["This install process will help you learn some of the features in ElvUI_ has to offer and also prepare your user interface for usage."] = true
...
L["Welcome to ElvUI_ version %s!"] = true
L["Wintergrasp"] = true
L["XP:"] = true
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = true
...
L["You can always change fonts and colors of any element of ElvUI_ from the in-game configuration."] = true
