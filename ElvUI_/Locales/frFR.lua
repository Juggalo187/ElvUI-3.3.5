...
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI_ and setting a keybind for the raid marker."] = "Une fonction marqueur de raid est disponible en appuyant sur Échap -> Raccourcis, défilez en bas d'ElvUI_ et paramétrez le raccourcis pour le marqueur de raid."
...
L["Are you sure you want to apply this font to all ElvUI_ elements?"] = "Êtes-vous sûr de vouloir appliquer cette police à tous les éléments d'ElvUI_ ?"
...
L["Detected that your ElvUI_ OptionsUI addon is out of date. This may be a result of your Tukui Client being out of date. Please visit our download page and update your Tukui Client, then reinstall ElvUI_. Not having your ElvUI_ OptionsUI addon up to date will result in missing options."] = "Nous avons détecté que votre installation d'ElvUI_ est périmée. Cela peut venir du client Tukui qui est également périmé. Merci de visiter notre page de téléchargement pour mettre à jour le client Tukui, puis réinstallez ElvUI_. Ne pas avoir la version à jour ElvUI_ peut entrainer des erreurs."
L["Disable Warning"] = "Désactiver l'alerte"
L["Disable"] = "Désactiver"
L["Disband Group"] = "Dissoudre le groupe"
L["Discard"] = "Annuler"
L["Discord"] = true
L["Do you enjoy the new ElvUI_?"] = "Aimez-vous le nouveau ElvUI_ ?"
...
L["Earned:"] = "Gagné :"
L["ElvUI_ Installation"] = "Installation d'ElvUI_"
L["ElvUI_ Plugin Installation"] = "Installation des plugins ElvUI_"
L["ElvUI_ has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "ElvUI_ dispose d'une fonction double spécialisation qui vous permet de charger à la volée des profils différents en fonction de votre spécialisation actuelle."
L["ElvUI_ is five or more revisions out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_"] = "ElvUI_ est périmé d'au moins 5 versions. Vous pouvez télécharger la nouvelle version sur https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_"
L["ElvUI_ is out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_"] = "ElvUI_ est périmé. Vous pouvez télécharger la nouvelle version sur https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_"
L["ElvUI_ needs to perform database optimizations please be patient."] = "ElvUI_ a besoin d'effectuer des optimisations de la base de données, merci de patienter."
L["ElvUI_ was updated while the game is still running. Please relaunch the game, as this is required for the files to be properly updated."] = true
...
L["For technical support visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = "Pour tout support technique, merci de nous rendre visite sur https://github.com/Juggalo187/ElvUI-3.3.5."
L["Frame"] = "Fenêtre"
...
L["INCOMPATIBLE_ADDON"] = "L'addon %s n'est pas compatible avec le module %s d'ElvUI_. Merci de sélectionner soit l'addon, soit le module d'ElvUI_, pour le désactiver."
L["Icons Only"] = "Icônes seulement"
L["If you accidently remove a chat frame you can always go the in-game configuration menu, press install, go to the chat portion and reset them."] = "Si vous supprimez accidentellement un cadre de discussion, vous pouvez toujours aller dans le menu de configuration d'ElvUI_. Cliquez ensuite sur Installation puis passez à l'étape concernant les fenêtres de discussion pour remettre à zéro les paramètres."
L["If you are experiencing issues with ElvUI_ try disabling all your addons except ElvUI_, remember ElvUI_ is a full UI replacement addon, you cannot run two addons that do the same thing."] = "Si vous rencontrez des problèmes avec ElvUI_, essayez de désactiver tous vos addons sauf ElvUI_. Rappelez-vous qu'ElvUI_ est une interface utilisateur complète et que vous ne pouvez pas exécuter deux addons qui font la même chose."
...
L["KEY_SPACE"] = "SpB"
L["Key"] = "Touche"
L["LOGIN_MSG"] = "Welcome to %sElvUI|r version %s%s|r, type /ec to access the in-game configuration menu. If you are in need of technical support you can visit us at https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_ or join our Discord: https://discord.gg/G6mUMD9TY"
...
L["Oh lord, you have got ElvUI_ and Tukui both enabled at the same time. Select an addon to disable."] = "Oh seigneur, vous avez ElvUI_ et Tukui d'activé en même temps. Sélectionnez un addon à désactiver."
...
L["Select the type of aura system you want to use with ElvUI_'s unitframes. Set to Aura Bar & Icons to use both aura bars and icons, set to icons only to only see icons."] = true
L["Server: "] = "Serveur : "
L["Session:"] = "Session :"
...
L["The chat windows function the same as Blizzard standard chat windows, you can right click the tabs and drag them around, rename, etc. Please click the button below to setup your chat windows."] = "La fenêtre de chat ElvUI_ utilise les même fonctions que celle de Blizzard, vous pouvez faire un clic droit sur un onglet pour le déplacer, le renommer, etc."
...
L["This install process will help you learn some of the features in ElvUI_ has to offer and also prepare your user interface for usage."] = "Ce programme d'installation vous aidera à découvrir quelques fonctionnalités qu'ElvUI_ offre et préparera également votre interface à son utilisation."
...
L["Welcome to ElvUI_ version %s!"] = "Bienvenue sur la version %s d'ElvUI_!"
L["Wintergrasp"] = true
L["XP:"] = "XP :"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = "Vous avez maintenant terminé le processus d'installation. Si vous avez besoin d'un support technique, merci de vous rendre sur https://github.com/Juggalo187/ElvUI-3.3.5."
...
L["You can always change fonts and colors of any element of ElvUI_ from the in-game configuration."] = "Vous pouvez toujours modifier les polices et les couleurs de n'importe quel élément d'ElvUI_ dans la configuration du jeu."
