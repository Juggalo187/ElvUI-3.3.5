...
L["FAQ_DESC"] = "이 섹션에는 ElvUI_ 및 Project Zidras에 대한 몇 가지 질문이 포함되어 있습니다."
L["FAQ_Elv_1"] = "|cff30ee30Q: 어디에서 ElvUI_ 지원을 받을 수 있나요?|r\n|cff9482c9A:|r 가장 좋은 방법은 ElvUI_ - Backport discord - https://discord.gg/G6mUMD9TY\n버그를 보고하려면 문제를 사용할 수 있습니다. https://github.com/Juggalo187/ElvUI-3.3.5/ElvUI_/issues에 있는 트래커.\n영어를 선택해야 하지만 러시아어인 경우 더 잘 전달하기 위해 러시아어로도 작성하는 것이 좋습니다. 러시아 개발자에게 보내는 메시지."
...
L["HD-Nameplates_DESC"] = "ElvUI_ 캐스트바를 모든 유닛 및 캐시된 GUID 명판에 대한 기본 Blizzard 명판 캐스트바에 적용합니다."
...
L["Modules"] = "모듈"
L["Normal"] = "보통"
L["Options for customizing unit frames. Please don't change these setting when ElvUI_'s testing frames for bosses and arena teams are shown. That will make them invisible until retoggling."] = "단위 프레임을 사용자 정의하기 위한 옵션입니다. 보스 및 투기장 팀에 대한 ElvUI의 테스트 프레임이 표시될 때 이 설정을 변경하지 마십시오. 그러면 다시 토글할 때까지 보이지 않게 됩니다."
