...
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI_ and setting a keybind for the raid marker."] = "你可以通过按ESC键 -> 按键设置, 滚动到ElvUI设置下方设置一个快速标记的快捷键."
...
L["Are you sure you want to apply this font to all ElvUI_ elements?"] = "确定要对所有ElvUI元素使用这个字体?"
...
L["Detected that your ElvUI_ OptionsUI addon is out of date. This may be a result of your Tukui Client being out of date. Please visit our download page and update your Tukui Client, then reinstall ElvUI_. Not having your ElvUI_ OptionsUI addon up to date will result in missing options."] = "检测到您的ElvUI设置插件已过期.这可能是因为您的 Tukui 客户端已过期.请访问我们的下载页面并更新 Tukui 客户端，然后重新安装ElvUI.ElvUI设置插件过期会造成某些选项丢失"
L["Disable Warning"] = "禁用警告"
L["Disable"] = "禁用"
L["Disband Group"] = "解散队伍"
L["Discard"] = "取消"
L["Discord"] = "Discord"
L["Do you enjoy the new ElvUI_?"] = "你喜欢新的ElvUI么？"
...
L["Earned:"] = "赚取:"
L["ElvUI_ Installation"] = "安装 ElvUI_"
L["ElvUI_ Plugin Installation"] = "ElvUI插件安装"
L["ElvUI_ has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "ElvUI可以根据你所使用的天赋自动套用不同的设置档. 你可以在配置文件中使用此功能."
L["ElvUI_ is five or more revisions out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5"] = "ElvUI已过期5个或者更多的版本。你可以在https://github.com/Juggalo187/ElvUI-3.3.5"
L["ElvUI_ is out of date. You can download the newest version from https://github.com/Juggalo187/ElvUI-3.3.5"] = "ElvUI已过期。你可以在www.tukui.org下载到最新的版本。"
L["ElvUI_ needs to perform database optimizations please be patient."] = "ElvUI需要进行数据库优化，请耐性等待。"
L["ElvUI_ was updated while the game is still running. Please relaunch the game, as this is required for the files to be properly updated."] = "ElvUI已更新，然而游戏仍在运行. 请重启游戏，以保证文件正确更新."
L["Empty Slot"] = "空拾取位"
L["Enable"] = "启用"
...
L["For technical support visit us at https://github.com/Juggalo187/ElvUI-3.3.5"] = "如需技术支援请至 https://github.com/Juggalo187/ElvUI-3.3.5."
L["Frame"] = "框架"
L["Friends List"] = "好友列表"
L["G"] = "公会"
...
L["I Swear"] = "我承诺"
L["INCOMPATIBLE_ADDON"] = "插件 %s 不相容于 ElvUI_ 的 %s 模组, 请停用不相容的插件, 或停用模组."
L["Icons Only"] = "图标"
...
L["If you are experiencing issues with ElvUI_ try disabling all your addons except ElvUI_, remember ElvUI_ is a full UI replacement addon, you cannot run two addons that do the same thing."] = "如果你遇到问题, ElvUI会尝试禁用你除了ElvUI之外的插件. 请记住你不能用不同的插件实现同一功能."
...
L["KEY_SPACE"] = "SpB"
L["Key"] = "键"
L["LOGIN_MSG"] = "Welcome to %sElvUI|r version %s%s|r, type /ec to access the in-game configuration menu. If you are in need of technical support you can visit us at https://github.com/Juggalo187/ElvUI-3.3.5_ or join our Discord: https://discord.gg/G6mUMD9TY"
L["Layout Set"] = "界面布局设置"
L["Layout"] = "界面布局"
L["Left Chat"] = "左侧对话框"
L["Left Click:"] = "左键:"
...
L["Offline"] = "离线"
L["Oh lord, you have got ElvUI_ and Tukui both enabled at the same time. Select an addon to disable."] = "你不能同时使用Elvui和Tukui，请选择一个禁用."
...
L["Select the type of aura system you want to use with ElvUI_'s unitframes. Set to Aura Bar & Icons to use both aura bars and icons, set to icons only to only see icons."] = "选择你想使用的光环系统类型. 选择光环条及图标将会同时显示光环条及图标，选择图标将只会显示图标."
L["Server: "] = "服务器: "
L["Session:"] = "本次登陆:"
L["Setup CVars"] = "设定参数"
L["Setup Chat"] = "设定聊天框"
...
L["Theme Set"] = "主题设置"
L["Theme Setup"] = "主题安装"
L["This install process will help you learn some of the features in ElvUI_ has to offer and also prepare your user interface for usage."] = "此安装程序有助你了解 ElvUI_ 部份功能，并可协助你预先设定 UI。"
...
L["Welcome to ElvUI_ version %s!"] = "欢迎使用 ElvUI_ 版本 %s!"
L["Wintergrasp"] = "冬拥湖"
L["XP:"] = "经验:"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/Juggalo187/ElvUI-3.3.5."] = "你已经完成安装过程. 如果你需要技术支持请访问https://github.com/Juggalo187/ElvUI-3.3.5"
...
L["You can always change fonts and colors of any element of ElvUI_ from the in-game configuration."] = "你可以在游戏内的设定选项内更改ElvUI的字体、颜色等设定."
...
L["You still have ElvUI_Config installed. ElvUI_Config has been renamed to ElvUI__OptionsUI, please remove it."] = "你插件里依然有ElvUI_Config，不过它已经重命名为ElvUI__OptionsUI，请删除它。"
