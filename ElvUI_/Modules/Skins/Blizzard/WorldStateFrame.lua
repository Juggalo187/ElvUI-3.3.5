...
S:AddCallback("Skin_WorldStateFrame", function()
	...
	local function captureBarCreate(id)
		...
		bar.leftBarIcon:SetTexture("Interface\\AddOns\\ElvUI_\\Media\\Textures\\Alliance-Logo-Small")
		...
		bar.rightBarIcon:SetTexture("Interface\\AddOns\\ElvUI_\\Media\\Textures\\Horde-Logo-Small")
